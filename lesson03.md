...
# :triangular_flag_on_post: 1. Что такое CSS.
...
# :triangular_flag_on_post: 2. Способы задания стилей
...
# :triangular_flag_on_post: 3. Селекторы CSS
...
# :triangular_flag_on_post: 4. Каскад (”вес” селекторов)
...
# :triangular_flag_on_post:  5. Комбинирование и группировка селекторов
...
# :triangular_flag_on_post: 6. Наследование
...
Вставьте на страницу блок с цитатой (о теге читем  [тут](https://developer.mozilla.org/ru/docs/Web/HTML/Element/blockquote)). 

Подключите CSS на созданной вами странице 3-мя способами (с помощью тега style, атрибута style и файла стилей style.css). 

Задайте цитате 3 разных варианта цвета (синий, красный и зеленый соответственно). Проанализируйте, какой из стилей имеет наивысший приоритет.
...
1) обратиться только к тем ссылкам, значение атрибута `href` которых начинается с **https**

2) применится только для последней ссылки в списке

3) будет действовать только для `<p>`, который идет после `<ul>`.
