...
:small_blue_diamond: Mozilla Firefox
...
**3.Третий уровень(“учусь печатать”)**
    ...
    Еще раз перечитываем раздел лекции  “6.Структура HTML-документа” и в выбраном Вами редакторе ПЕЧАТАЕМ (а не копируем!) “скелет” html-файла. Сохраняем его как файл _**`index.html`**_
