...
Чтобы **объединить ячейки по горизонтали** используйте атрибут colspan="_х_", у ячейки [<td>](https://guruweba.com/html/teg-td-html-yacheyka-tablitsy/) или [<th>](https://guruweba.com/html/teg-th-html-yacheyka-zagolovok-v-tablitse/), где _x_ - количество ячеек для объединения.

Чтобы **объединить ячейки по вертикали** используйте атрибут rowspan="_х_", у ячейки [<td>](https://guruweba.com/html/teg-td-html-yacheyka-tablitsy/) или [<th>](https://guruweba.com/html/teg-th-html-yacheyka-zagolovok-v-tablitse/), где _x_ - количество ячеек для объединения.
...
![](https://github.com/olgamaslovaolga/Alevel-Markup/raw/master/images/img-layout01.png)"width: 500px"
